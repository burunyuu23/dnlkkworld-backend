...
var QuestionnairesController = function () {
    var _classDecorators = [(0, common_1.Controller)('questionnaires')];
    ...
    var QuestionnairesController = _classThis = /** @class */ (function () {
        ...
        QuestionnairesController_1.prototype.create = function (createQuestionnaireDto) {
            return this.questionnairesService.create(createQuestionnaireDto);
        };
        QuestionnairesController_1.prototype.findAll = function () {
            return this.questionnairesService.findAll();
        };
        QuestionnairesController_1.prototype.findOne = function (id) {
            return this.questionnairesService.findOne(id);
        };
        QuestionnairesController_1.prototype.update = function (id, updateQuestionnaireDto) {
            return this.questionnairesService.update(+id, updateQuestionnaireDto);
        };
        QuestionnairesController_1.prototype.remove = function (id) {
