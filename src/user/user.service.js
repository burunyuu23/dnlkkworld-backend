...
var UserService = function () {
    ...
    var UserService = _classThis = /** @class */ (function () {
        function UserService_1(keycloak) {
            this.keycloak = keycloak;
        }
        UserService_1.prototype.getHello = function () {
            return 'hello!';
        };
        UserService_1.prototype.getUserById = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.keycloak.getUsers()];
                        case 1: return [2 /*return*/, (_a.sent()).find({
                                id: id,
                            })];
                    }
                });
